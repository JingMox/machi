...
use machi::{
    InProcessHost, Journal, LlmSampler, MachiError, MockSampler, SampleRequest, SampleResponse,
...
async fn main() -> Result<(), String> {
    let dir = std::env::temp_dir().join(format!("machi-wf-resume-{}", std::process::id()));
