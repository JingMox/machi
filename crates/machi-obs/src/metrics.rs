...
pub const METRIC_TURNS_TOTAL: &str = "machi_turns_total";
/// Histogram: steps consumed per turn.
pub const METRIC_TURN_STEPS: &str = "machi_turn_steps";
/// Histogram: turn wall duration in milliseconds.
pub const METRIC_TURN_DURATION_MS: &str = "machi_turn_duration_ms";
/// Counter: tool calls by tool name and status.
pub const METRIC_TOOL_CALLS_TOTAL: &str = "machi_tool_calls_total";
/// Histogram: tool duration in milliseconds.
pub const METRIC_TOOL_DURATION_MS: &str = "machi_tool_duration_ms";
/// Histogram: LLM sample duration in milliseconds.
pub const METRIC_SAMPLE_DURATION_MS: &str = "machi_sample_duration_ms";
/// Counter: tokens by direction (`input`, `output`).
pub const METRIC_TOKENS_TOTAL: &str = "machi_tokens_total";
/// Counter: nested agent spawns by status.
pub const METRIC_SPAWNS_TOTAL: &str = "machi_spawns_total";
/// Counter: workflow runs by outcome.
pub const METRIC_WORKFLOW_RUNS_TOTAL: &str = "machi_workflow_runs_total";
/// Counter: workflow agent slots consumed.
pub const METRIC_WORKFLOW_AGENTS_TOTAL: &str = "machi_workflow_agents_total";
